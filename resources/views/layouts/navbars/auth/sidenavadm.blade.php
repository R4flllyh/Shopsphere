<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            ...
            <span class="ms-1 font-weight-bold">Shop Sphere Admin</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " style="height: 100%" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'dashboard-admin' ? 'active' : '' }}" href="{{ route('dashboard-admin') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'product') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'product']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fi fi-rr-shopping-bag text-warning text-lg opacity-10"></i>
                    </div>
